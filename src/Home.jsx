...
//       <div className="size-10xl z-0 -left-95 -top-90 rounded-full bg-black/15 absolute"></div>
//       <div className="size-9xl z-0 -left-85 -top-80 rounded-full bg-white/15 absolute"></div>
//       <section className="w-30 m-5 rounded-full bg-store-bg2/70 z-10 overflow-hidden"><Menu/></section>
//       <section className="flex-1 p-5 m-5 rounded-7xl bg-store-bg2/70 z-10 overflow-hidden">
