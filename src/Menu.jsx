export function Menu() {
    return(
        <div className="h-full px-6 flex flex-col justify-evenly items-center">
            <div className="size-22 justify-center items-center rounded-full bg-store-items"></div>
            ...
            <section className="w-full flex flex-col gap-6 justify-evenly items-center">
                ...
                <article className="size-22 justify-center items-center rounded-full bg-store-items">
                    <a href="" className="h-full w-full flex justify-center items-center">
